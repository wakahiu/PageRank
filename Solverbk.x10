...
public class Solver
{
    ...
    public def solve(webGraph: Rail[WebNode], dampingFactor: Double, epsilon:Double) : Rail[Double] {
        ...
        Console.OUT.println("0_______________________");
        val place1 = PlaceGroup.WORLD(0);
        val place2 = PlaceGroup.WORLD(1);
       
		 Console.OUT.println("1_______________________");
        val indexMap = 
        ...
        var gSolutionVar:PlaceLocalHandle[Rail[Double]] = 
		 ...
		 Console.OUT.println("2_______________________");
		...
		Console.OUT.println("3_______________________");
